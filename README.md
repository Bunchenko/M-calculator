...
Start the project by typing this command in console:

- **yarn start** - starts the development server

## Running tests

In order to run tests, start the project (see previous paragraph) and run this command in console:

- **yarn run cypress open** - opens cypress from project root

Then choose E2E testing and preferred browser. In opened browser window choose any spec and press on it in order to run. All specs are available in the according menu.

You can see the code of all tests in cypress/e2e directory.
